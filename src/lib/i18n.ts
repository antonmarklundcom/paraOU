...
const es = {
  ...
  profileSwitcher: {
    ...
    deleteConfirm: "¿Eliminar este perfil? Se borran sus coincidencias, búsquedas y seguimientos.",
    unlimited: "ilimitados",
    of: "de",
    profilesUsed: "perfiles",
    addLocked: "Actualizá tu plan para agregar más perfiles de empresa.",
    deleteLastError: "No podés eliminar tu único perfil.",
  },
  panel: {
    title: "Mi panel",
  ...
  cuenta: {
    ...
    alertChannelBoth: "Correo y WhatsApp",
    ...
    rename: "Renombrar",
    delete: "Eliminar",
    whatsappTitle: "Alertas por WhatsApp",
    whatsappHint:
      "Recibí los avisos donde ya trabajás. Verificamos tu número con un código antes de enviarte nada.",
    whatsappPhone: "Número de WhatsApp",
    whatsappPhonePlaceholder: "0981 123 456",
    whatsappSendCode: "Enviar código",
    whatsappCode: "Código de verificación",
    whatsappCodePlaceholder: "123456",
    whatsappConfirm: "Verificar",
    whatsappResend: "Enviar otro código",
    whatsappRemove: "Quitar número",
    whatsappStatusVerified: "Número verificado",
    whatsappStatusPending: "Esperando el código",
    whatsappStatusFailed: "No pudimos entregar los mensajes a este número. Verificalo de nuevo.",
    whatsappStatusOptedOut: "Diste de baja WhatsApp. Verificá el número otra vez para reactivarlo.",
    whatsappStopHint:
      "Podés responder BAJA en WhatsApp en cualquier momento para dejar de recibir avisos.",
    whatsappDevTransport:
      "Modo de prueba: todavía no hay una cuenta de WhatsApp conectada — el código se escribe en el log del servidor.",
  ...
  pricing: {
    ...
    businessDesc:
      "Para equipos que compiten en varios rubros — hasta 3 perfiles de empresa y alertas por WhatsApp.",
    agencyDesc: "Para consultoras y agencias que gestionan varios clientes — perfiles ilimitados.",
  ...
  upgrade: {
    ...
    whatsappLocked: "Las alertas por WhatsApp son del plan Business.",
    cta: "Ver planes",
  },
  planificacion: {
